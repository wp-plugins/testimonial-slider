...
function testimonial_post_processor_round( $posts, $testimonial_slider_curr,$out_echo,$set,$data=array() ){
	...
	foreach($posts as $post) {
		...
		$testimonial_by_wrap='<div class="testimonial_avatar_wrap" '.$testimonial_slider_css['testimonial_avatar_wrap'].'><span class="testimonial_avatar" '.$testimonial_slider_css['testimonial_avatar'].'><img src="'.$_testimonial_avatar.'" '.$testimonial_slider_css['testimonial_avatar_img'].' /></span></div><div class="testimonial_by_wrap" '.$testimonial_slider_css['testimonial_by_wrap'].'><div class="testimonial_by_text"><span class="testimonial_by" '.$testimonial_slider_css['testimonial_by'].'>'.$_testimonial_by.'</span><span class="testimonial_site" '.$testimonial_slider_css['testimonial_site_a'].'>'.$testimonial_company.'</span></div></div>';
		...
		$testimonial_quote='<div class="testimonial_content_wrap" ><div class="testimonial_content" '.$testimonial_slider_css['testimonial_quote'].'>'.$slider_excerpt.$read_more.'</div></div>';
